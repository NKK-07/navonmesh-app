    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px;">
        ...
        <div class="card">
          ...
          <span style="font-size: 12px; color: #04785C; font-weight: bold;">+1.8 kWh Net Surplus</span>
        </div>
        <div class="card">
      ...
      <div class="card" style="display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="display: flex; gap: 16px; font-size: 13px; font-weight: 700;">
            <span style="color: #6B5F55;">━ Temperature (°C)</span>
            <span style="color: #6B5F55;">┅ Humidity (% RH)</span>
          </div>
        </div>
        ...
        <svg viewBox="0 0 700 200" style="width: 100%; height: 220px; overflow: visible;">
          <!-- Gridlines -->
          <line x1="40" y1="20" x2="680" y2="20" stroke="#E5DDD2" stroke-width="1"/>
          <line x1="40" y1="70" x2="680" y2="70" stroke="#E5DDD2" stroke-width="1"/>
          <line x1="40" y1="120" x2="680" y2="120" stroke="#E5DDD2" stroke-width="1"/>
          <line x1="40" y1="170" x2="680" y2="170" stroke="#E5DDD2" stroke-width="2"/>

          <!-- Target Temp Line (8°C) -->
          <line x1="40" y1="120" x2="680" y2="120" stroke="#04785C" stroke-dasharray="4,4" stroke-width="2"/>
          <text x="685" y="124" fill="#04785C" font-size="11" font-weight="bold">Target (8°C)</text>

          <!-- Temperature Path -->
          <path d="M 40 115 Q 150 110 250 125 T 450 118 T 680 120" fill="none" stroke="#6B5F55" stroke-width="4"/>

          <!-- Temperature Points -->
          <circle cx="40" cy="115" r="5" fill="#6B5F55"/>
          <circle cx="250" cy="125" r="5" fill="#6B5F55"/>
          <circle cx="450" cy="118" r="5" fill="#6B5F55"/>
          <circle cx="680" cy="120" r="5" fill="#6B5F55"/>
          
          <!-- Temp values overlay -->
          <text x="40" y="100" font-size="11" font-weight="bold" fill="#6B5F55">8.5°C</text>
          <text x="250" y="145" font-size="11" font-weight="bold" fill="#6B5F55">7.8°C</text>
          <text x="450" y="105" font-size="11" font-weight="bold" fill="#6B5F55">8.1°C</text>
          <text x="660" y="105" font-size="11" font-weight="bold" fill="#6B5F55">${state.temperature.toFixed(1)}°C</text>

          <!-- Humidity Path (Dashed Blue) -->
          <path d="M 40 40 Q 150 45 250 35 T 450 42 T 680 38" fill="none" stroke="#6B5F55" stroke-dasharray="6,4" stroke-width="3"/>
          <text x="685" y="42" fill="#6B5F55" font-size="11" font-weight="bold">91% RH</text>

          <!-- Time X Labels -->
          <text x="40" y="192" font-size="11" fill="#6B5F55">00:00</text>
          <text x="200" y="192" font-size="11" fill="#6B5F55">06:00</text>
          <text x="360" y="192" font-size="11" fill="#6B5F55">12:00 (Peak)</text>
          <text x="520" y="192" font-size="11" fill="#6B5F55">18:00</text>
          <text x="660" y="192" font-size="11" fill="#6B5F55">Now</text>
        </svg>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 20px;">
        ...
        <div class="card">
          ...
          <svg viewBox="0 0 350 160" style="width: 100%; height: 160px;">
            <rect x="20" y="120" width="30" height="20" fill="#C99A4E" rx="4"/>
            <rect x="70" y="80" width="30" height="60" fill="#C99A4E" rx="4"/>
            <rect x="120" y="30" width="30" height="110" fill="#A9601F" rx="4"/>
            <rect x="170" y="20" width="30" height="120" fill="#A9601F" rx="4"/>
            <rect x="220" y="45" width="30" height="95" fill="#A9601F" rx="4"/>
            <rect x="270" y="90" width="30" height="50" fill="#C99A4E" rx="4"/>

            <text x="135" y="20" font-size="11" font-weight="bold" fill="#A9601F">2.8kW</text>
            <text x="185" y="12" font-size="11" font-weight="bold" fill="#A9601F">3.0kW</text>
            
            <line x1="10" y1="140" x2="330" y2="140" stroke="#E5DDD2" stroke-width="2"/>
            <text x="25" y="155" font-size="10" fill="#6B5F55">06h</text>
            <text x="75" y="155" font-size="10" fill="#6B5F55">09h</text>
            <text x="125" y="155" font-size="10" fill="#6B5F55">12h</text>
            <text x="175" y="155" font-size="10" fill="#6B5F55">14h</text>
            <text x="225" y="155" font-size="10" fill="#6B5F55">16h</text>
            <text x="275" y="155" font-size="10" fill="#6B5F55">18h</text>
          </svg>
        </div>
        ...
        <div class="card">
          ...
          <svg viewBox="0 0 350 160" style="width: 100%; height: 160px;">
            <path d="M 20 70 Q 100 90 180 30 T 330 45 L 330 140 L 20 140 Z" fill="#E4EFE9" opacity="0.6"/>
            <path d="M 20 70 Q 100 90 180 30 T 330 45" fill="none" stroke="#04785C" stroke-width="3"/>
            <circle cx="330" cy="45" r="5" fill="#04785C"/>
            <text x="290" y="35" font-size="12" font-weight="bold" fill="#04785C">${Math.round(state.batterySoc)}% SOC</text>

            <line x1="10" y1="140" x2="330" y2="140" stroke="#E5DDD2" stroke-width="2"/>
            <line x1="10" y1="110" x2="330" y2="110" stroke="#A6321F" stroke-dasharray="3,3" stroke-width="1"/>
            <text x="15" y="105" font-size="9" fill="#A6321F" font-weight="bold">30% PCM Threshold</text>
          </svg>
        </div>
