...
export function renderConnectivityPage(state, currentLang) {
  return `
    <div style="display: flex; flex-direction: column; gap: 24px;">
      ...
      <div class="card" style="background: linear-gradient(135deg, #EAF1EE 0%, #FFFFFF 100%); border: 2px solid var(--agri-green);">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
        <div class="card">
          ...
          <div style="font-size: 24px; font-weight: 900; color: #047857; margin-top: 4px;"><i class="dot dot-ok"></i> CONNECTED</div>
        ...
        <div class="card">
          ...
          <div style="font-size: 24px; font-weight: 900; color: #047857; margin-top: 4px;"><i class="dot dot-ok"></i> READY</div>
        ...
        <div class="card">
          ...
          <div style="font-size: 24px; font-weight: 900; color: #B45309; margin-top: 4px;"><i class="dot dot-warn"></i> STANDBY</div>
        ...
        <div class="card">
          ...
          <div style="font-size: 24px; font-weight: 900; color: #4A5461; margin-top: 4px;">${state.isOnline ? '<i class="dot dot-ok"></i> ONLINE' : '<i class="dot dot-danger"></i> OFFLINE'}</div>
      ...
      <div class="card">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
          <div style="background: #EAF1EE; border: 2px solid #047857; padding: 16px; display: flex; align-items: center; justify-content: space-between;">
            <div>
          ...
          <div style="background: #FBF3E2; border: 2px solid #B45309; padding: 16px; display: flex; align-items: center; justify-content: space-between;">
            <div>
          ...
          <div style="background: #FAFBF9; border: 2px solid #6B7683; padding: 16px; display: flex; align-items: center; justify-content: space-between;">
            <div>
              <strong style="font-size: 16px; color: #2E3742;">3. Wi-Fi / Cloud Sync (When Available)</strong>
            ...
            <span class="metric-status-badge" style="background: #D5D9DE; color: #4A5461;">OPPORTUNISTIC</span>
          </div>
        </div>
      </div>
